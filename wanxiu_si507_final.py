...
def show_shiny_scatter_plot(shiny_list,pokemon):
    xvals = ["Found in Egg","Found in Evolution","Found in Raid","Found in Research","Found in Wild"]
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if your_choice == "2":
            ...
            while pokemon not in POKEMON_DICT:
                print("WRONG INPUT!")
                pokemon = input("Who am I?\n")
            else:
        ...
        if your_choice == "4":
           pokemon =  input("Input the Pokemon you wanna search\n")
           while pokemon not in POKEMON_DICT:
                print("WRONG INPUT!")
                pokemon =  input("Input the Pokemon you wanna search\n")
           else: 
                shiny_list = if_the_pokemon_shinny(pokemon)
                show_shiny_scatter_plot(shiny_list,pokemon)
        if your_choice =="exit":
            break
